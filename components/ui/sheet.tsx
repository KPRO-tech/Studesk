...
function SheetTrigger({
  ...
  // The project's base-ui primitives use a `render` prop instead of Radix's
  // `asChild`. Support both so existing call sites keep working.
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-popover text-popover-foreground shadow-lg ring-1 ring-foreground/10 outline-none duration-200 data-open:animate-in data-closed:animate-out",
          side === "right" &&
